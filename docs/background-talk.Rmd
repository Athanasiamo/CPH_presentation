...
theme_set(theme_minimal(base_size=25, base_family="Avenir"))
...
```{r "nyberg", out.width="70%", fig.align="center"}
include_graphics("figures/nyberg_pnas_2010_fig3_transp.png")
```
...
```{r "hierarch", out.width="60%", fig.align="center"}
include_graphics("figures/hierarchical_transp.png")
```
<div class="citation">
